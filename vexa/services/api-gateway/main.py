...
# TRANSCRIPTION_COLLECTOR_URL supprimé car on utilise Gladia directement
...
async def forward_request(client: httpx.AsyncClient, method: str, url: str, request: Request) -> Response:
    ...
    if is_admin_request:
        ...
        # Forward client API key for bot-manager
...
async def get_meeting_by_id_proxy(meeting_id: int, request: Request):
    """Forward request to Bot Manager to get meeting by ID."""
